...
1¡¢This package make out Image.gz-dtb only, you have to get ramdisk and add kernel cmdline to generate a total boot.img before replace your phone's bootimage.
...
This kernel package is released for the phone software version--  SLA-130